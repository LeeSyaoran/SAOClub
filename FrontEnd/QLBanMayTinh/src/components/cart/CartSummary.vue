<template>
  <div class="px-4 py-3 d-flex flex-column gap-2" style="border-top:1px solid var(--border-color-soft); background:var(--bg-page-alt);">
    ...
    <button
      class="btn btn-warning fw-bold w-100 py-2 mt-1"
