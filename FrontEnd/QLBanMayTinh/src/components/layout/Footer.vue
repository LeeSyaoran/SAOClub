      ...
      <div class="row g-4">
        <div class="col-12 col-sm-6 col-xl-3">
          ...
          <div>
            ...
            <div class="d-flex flex-wrap gap-1">
              <span
                v-for="pay in paymentMethods" :key="pay"
                class="badge fw-bold"
        ...
        <div class="col-12 col-sm-6 col-xl-3">
          ...
          <div class="p-3 rounded-4" style="background:var(--bg-hover); border:1px solid var(--border-color);">
            ...
            />
            <button
              class="btn btn-warning btn-sm w-100 fw-black" disabled
        ...
        <div class="col-12 col-sm-6 col-xl-3">
          ...
          <div class="d-flex gap-2 mb-4">
            <a
              href="#" class="d-flex align-items-center justify-content-center rounded-circle text-decoration-none"
          ...
          >
            <div
              ...
              style="width:44px; height:44px; background:radial-gradient(circle, var(--bg-input), var(--bg-card-inset));"
            ></div>
            <div class="d-flex flex-column gap-1">
              <button
                class="btn btn-sm fw-black"
    ...
    <div class="container-xl py-4">
      <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
        ...
        <div class="d-flex gap-2 align-items-center flex-shrink-0">
          <div
            class="px-2 py-1 rounded-2 fw-bold"
