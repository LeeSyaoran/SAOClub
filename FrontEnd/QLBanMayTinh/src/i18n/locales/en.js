export default {
  ...
  productDetail: {
    ...
    voucherBadge: "Save {percent}",
    voucherTitle: "Voucher {percent}",
    voucherDesc: "Save {amount} on orders from {min} · Expires: {date}",
    voucherAction: "Collect",
    voucherCollected: "Collected",
    shippingInfo: "Shipping Information",
    shippingFast: "2 Hours",
    shippingNote: "Available in some areas near {city}",
    changeAddress: "Change delivery address for offers",
    buyNow: "BUY NOW",
    buyNowNote: "Fast delivery from 2 hours or pickup in store",
    installment: "0% Installment",
    installmentNote: "0đ down · 0đ fee",
    addToCartShort: "Add to Cart",
    paymentMethods: "Payment Methods",
    qna: "Q&A",
    benefit1: "0% interest installment, up to 12 months, from 10% down via CTTC or 0đ via credit card",
    benefit2: "Save up to 1 million VND when paying with HSBC credit card",
    benefit3: "Get Office 365 Personal for 1 year when buying with a Laptop",
    specShort: "Specs",
    readMore: "View all",
