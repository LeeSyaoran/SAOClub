export default {
  ...
  checkout: {
    ...
    errValidation: "Vui lòng kiểm tra lại thông tin giao hàng.",
    ...
    orderNotesPlaceholder: "Giao giờ hành chính, gọi trước khi giao...",
    copy: "Sao chép",
    copied: "Đã sao chép!",
    phoneNoticeMissing: "Vui lòng cung cấp số điện thoại nhận hàng",
  ...
  productDetail: {
    ...
    notFoundDesc: "Sản phẩm bạn đang tìm không tồn tại hoặc đã bị xoá.",
    backHome: "Về trang chủ",
    breadcrumbHome: "Trang chủ",
    highlights: "Tính năng nổi bật",
    configuration: "Cấu hình chi tiết",
    promotionHeading: "Khuyến mãi đi kèm",
    viewAllVouchers: "Xem tất cả voucher",
    voucherBadge: "Giảm {percent}",
    voucherTitle: "Voucher {percent}",
    voucherDesc: "Giảm {amount} khi đơn từ {min} · Thời hạn: {date}",
    voucherAction: "Thu thập",
    voucherCollected: "Đã thu thập",
    shippingInfo: "Thông tin vận chuyển",
    shippingFast: "2 Giờ",
    shippingNote: "Áp dụng một số khu vực tại {city}",
    changeAddress: "Chọn địa chỉ giao hàng để nhận ưu đãi",
    buyNow: "MUA NGAY",
    buyNowNote: "Giao nhanh từ 2 giờ hoặc nhận tại cửa hàng",
    installment: "Trả góp 0%",
    installmentNote: "Trả trước 0đ · Phụ phí 0đ",
    addToCartShort: "Thêm vào giỏ",
    paymentMethods: "Phương thức thanh toán",
    qna: "Hỏi đáp",
    benefit1: "trả góp 0% lãi suất, tối đa 12 tháng, trả trước từ 10% qua CTTC hoặc 0đ qua thẻ tín dụng",
    benefit2: "Giảm đến 1 triệu khi thanh toán qua thẻ tín dụng HSBC",
    benefit3: "Tặng Office 365 Personal 1 năm khi mua kèm Laptop",
    specShort: "Thông số",
    readMore: "Xem tất cả",
    freeShipping: "Miễn phí vận chuyển",
    versions: "Phiên bản ({count})",
    colorHeading: "Màu sắc",
    months: "tháng",
    specs: {
      cpu: "Bộ xử lý (CPU)",
  ...
  account: {
    ...
    menuWarranty: "Tra cứu bảo hành",
    menuOverview: "Tổng quan",

    warranty: {
      statActive: "Còn hạn BH",
      statExpired: "Đã hết hạn",
      statProcessing: "Đang xử lý",
      filterAll: "Tất cả",
      filterActive: "Còn hạn",
      filterExpired: "Hết hạn",
      remaining: "Còn lại",
      daysLeft: "{count} ngày",
      buyBack: "Yêu cầu bảo hành",
      processing: "Đang xử lý",
      expired: "Đã hết hạn BH",
      serial: "Serial",
      linhKien: "Linh kiện",
      laptop: "Laptop",
      all: "Tất cả",
      ...
      badgeActive: "Còn hạn",
      badgeNearExpiry: "Sắp hết",
      badgeExpired: "Hết hạn",
      formTitle: "Yêu cầu bảo hành",
      issueDescription: "Mô tả lỗi",
      issuePlaceholder: "Mô tả chi tiết lỗi bạn gặp phải (vd: máy không lên nguồn, pin chai nhanh, màn hình sọc,...)",
      issueRequired: "Vui lòng mô tả lỗi",
      issueTooShort: "Mô tả lỗi cần ít nhất 10 ký tự",
      uploadTitle: "Ảnh / Video minh chứng",
      uploadHint: "JPG, PNG, WebP, MP4 (tối đa 20MB mỗi file)",
      ...
      submit: "Gửi yêu cầu",
      submitting: "Đang gửi...",
      submitSuccess: "Gửi yêu cầu bảo hành thành công",
      cancel: "Hủy",
      claimsAll: "Tất cả",
      claimsActive: "Đang xử lý",
      claimsDone: "Hoàn thành",
      claimsRejected: "Từ chối",
      claimsCancelled: "Đã hủy",
      claimsEmpty: "Chưa có phiếu bảo hành",
      claimsEmptyHint: 'Bạn chưa gửi yêu cầu bảo hành nào. Vào tab "Sản phẩm của tôi" để tạo yêu cầu.',
      noClaimsAtFilter: "Không có phiếu nào ở trạng thái này",
      cancelClaim: "Hủy phiếu",
      cancelConfirm: "Bạn chắc chắn muốn hủy phiếu #{id}?",
      cancelSuccess: "Đã hủy phiếu bảo hành",
      cancelFailed: "Không thể hủy phiếu. Vui lòng liên hệ CSKH.",
      detailTitle: "Phiếu bảo hành #{id}",
      detailProduct: "Sản phẩm",
      detailSku: "Mã SKU",
      detailSerial: "Serial",
      detailOrder: "Mã đơn hàng",
      detailPurchaseDate: "Ngày mua",
      ...
      noMedia: "Không có ảnh/video đính kèm",
      commentsSection: "Trao đổi với nhân viên",
      noComments: "Chưa có trao đổi nào. Bạn có thể gửi thêm thông tin cho nhân viên ở dưới.",
      commentPlaceholder: "Nhập nội dung trao đổi...",
      send: "Gửi",
      sendSuccess: "Đã gửi bình luận",
  ...
  admin: {
    ...
    variants: {
      ...
      colPriceBuy: "Giá nhập",
      rowHint: "Click dòng để xem chi tiết / sửa biến thể",
      statusWait: "Chờ nhập hàng",
      noBarcodeShort: "Chưa có",
      margin: "Biên LN",
      viewProduct: "Xem sản phẩm",
      printLabel: "In tem",
      genBarcode: "Tạo mã vạch",
    },
    ...
    customerDetail: {
      ...
      wishlistEmpty: "Khách hàng chưa có sản phẩm yêu thích nào.",
      colOrderCode: "Mã đơn",
      colOrderDate: "Ngày đặt",
    ...
    warrantyClaimModal: {
      ...
      cancel: "Hủy",
      save: "Lưu",
      savedToast: "Đã cập nhật tồn kho thành công",
    },
    ...
    inventory: {
      ...
      syncGiaNhapFailed: "Đồng bộ giá nhập thất bại",
      quickViewNote: "Xem nhanh tồn kho",
      quickViewClear: "Bỏ chọn xem nhanh",
      colProductCode: "Mã SP",
      colPriceBuy: "Giá nhập",
    ...
    stockDetailModal: {
      ...
      colStatus: "Trạng thái",
      searchPlaceholder: "Tìm kiếm serial...",
    ...
    pos: {
      ...
      barcodePlaceholder: "Quét mã vạch hoặc nhập mã serial / SKU...",
      loading: "Đang tải...",
